# Lithium $2\,{}^2P^o$ density example

This directory contains a 100-function `RG_1P` example for the four-particle lithium atom. It evaluates coordinate- and momentum-space particle densities and pair correlation functions on a piecewise cylindrical grid.
