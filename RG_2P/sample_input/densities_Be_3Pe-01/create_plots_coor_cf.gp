...
#   <name>_axial_dist.png  ->  2*pi*xi_rho * g(xi_rho, xi_z)
#
...
do for [c=3:ncol] {
    ...
    # The calculation grid includes negligible long-range tails; use a tighter
    # aspect-preserving window so the correlation structure remains visible.
    if (name eq "g1") {
        direct_rho = 0.75
        direct_z = 0.75
        axial_rho = 3.75
