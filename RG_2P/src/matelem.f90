...
!Evaluation of correlation functions
  ...
  end subroutine MatrixElementsAll_RG_2P
...
!the orbit-orbit section of MatrixElementsAll_RG_2P. All matrices
...
!        t_JXV=tr[inv_tAkl*Jij*inv_tAkl*X*inv_tAkl*tvl*tvk']=tvk'*Aj*AjX'*inv_tAkltvl
  ...
  !!!!! END D2 terms !!!!
    ...
    RVl = -(RVl1 + RVl2 + RVl3)*commonFactor
    ...
    RWl = -(RWl1 + RWl2 + RWl3)*commonFactor
